...
# Add the parent directory to sys.path so we can import from Client folder
# This assumes performance_test.py is in the performance folder which is a sibling to Client
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Now we can import ChatClient
